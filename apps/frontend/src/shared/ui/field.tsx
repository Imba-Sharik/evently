...
function FieldTitle({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-lg leading-snug font-medium group-data-[disabled=true]/field:opacity-50",
        className
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentPropsWithoutRef<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-muted-foreground text-lg leading-normal font-normal group-has-[[data-orientation=horizontal]]/field:text-balance",
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "relative -my-2 h-5 text-lg group-data-[variant=outline]/field-group:-mb-2",
        className
      )}
      {...props}
    >
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-destructive text-lg font-normal", className)}
      {...props}
    >
      {content}
    </div>
